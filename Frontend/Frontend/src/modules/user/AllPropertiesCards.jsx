...
//               /> */}
//               <img
//   src={`http://localhost:8001/uploads/${property.propertyImages?.[0]}`}
//   alt="property"
//   className="w-full h-40 object-cover"
// />
//               <div className="p-4">
              ...
              <img
                src={
                  property.propertyImages?.[0]
                    ? `http://localhost:8001/uploads/${property.propertyImages[0]}`
            ...
            <img
              src={
                selectedProperty.propertyImages?.[0]
                  ? `http://localhost:8001/uploads/${selectedProperty.propertyImages[0]}`
                  : "https://via.placeholder.com/400"
              }
              alt="Property"
              className="w-full h-48 object-cover rounded mb-4"
